...
var TasksService = (function () {
    ...
    TasksService.prototype.saveTask = function (task) {
        ...
        return this._http
            .post("http://localhost:3000/tasks/add", task, { headers: headers })
    ...
    TasksService.prototype.getTasks = function (query) {
        ...
        this.createAuthHeader(headers);
        return this._http
            .post("tasks/list", query, { headers: headers })
            .map(function (resp) { return resp.json(); });
    };
    return TasksService;
}());
...
var UserService = (function () {
    ...
    UserService.prototype.createAccount = function (user) {
        return this._http.post("users/register", user).map(function (resp) { return resp.json(); });
    };
    UserService.prototype.auth = function (user) {
        return this._http.post("users/auth", user).map(function (resp) { return resp.json(); });
    };
